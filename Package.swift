...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.0.0-beta+20230515174624.xcframework.zip",
			checksum: "6cacfff7e414b7f46ff4f89353780124227a8fce5d80b69b312648c43c186b40"
		)
	]
)