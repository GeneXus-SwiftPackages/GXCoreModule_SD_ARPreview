...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.2.0-beta.14.xcframework.zip",
			checksum: "527e0421dcd8c8c325872998357ae1406a73d9835ff2ab15c98e24e32689dcc6"
		)
	]
)