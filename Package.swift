...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.2.0-beta.19.xcframework.zip",
			checksum: "75f5e97dc99a6ac4644fbbfa2bb2c497b9c3125a1c1c277e67f7ddebae7cf738"
		)
	]
)