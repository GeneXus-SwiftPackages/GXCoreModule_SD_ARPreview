...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-4.2.0-rc.20.xcframework.zip",
			checksum: "d73512eadc8a5c95627ac9c7a865288e7d192024e7fc789c52f583f07fa15910"
		)
	]
)