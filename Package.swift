...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.0.0-beta.22.xcframework.zip",
			checksum: "09cd1f8fc85d20d615c164102bd0b64a2c09d3435362016e8d36c8ba910054ed"
		)
	]
)