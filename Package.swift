...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.4.0-beta.12.xcframework.zip",
			checksum: "be9af3f6b0efb62d572534b41e5bbf4b0aa0181896f9276647617d748e1c1224"
		)
	]
)