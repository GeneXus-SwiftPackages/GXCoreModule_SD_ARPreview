...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.1.0-beta.24.xcframework.zip",
			checksum: "f3a2937af2fc2e25f2cb83852d757e7f43dbd9db20104c8895f25488f25f340a"
		)
	]
)