...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.1.0-beta.7.xcframework.zip",
			checksum: "64afc9c7b7a09fe68c94ff4413f5dff701d4038363cfbd4271a6125ed12e523e"
		)
	]
)