...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.2.0-beta.26.xcframework.zip",
			checksum: "6988df8fe0c63d7baf17776bdaed94fe3b457df82ea20dd8da3882d3005e92ff"
		)
	]
)