...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.2.0-beta.19.xcframework.zip",
			checksum: "27a159603080adbdada5fdbf0ef9fce534384f54625bec85b56fda54b8621564"
		)
	]
)