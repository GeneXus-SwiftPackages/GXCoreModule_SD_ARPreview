...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.4.0-beta.11.xcframework.zip",
			checksum: "d0ac1d2162bf401248fd94b3ae0ce1655cb5cd60205e36c60446d2daaa9b14ef"
		)
	]
)