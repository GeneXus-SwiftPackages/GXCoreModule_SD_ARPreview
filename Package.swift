...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.5.0-beta.6.xcframework.zip",
			checksum: "a20a7b062a03cedde0f9d3f747f14396d2b982877b214a695c4172b79bfa72bb"
		)
	]
)