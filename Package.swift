...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.5.0-beta.8.xcframework.zip",
			checksum: "1f0e23bece7ae9999f3e56ec3d81e9f8cf19c88ef97ef3a4802d0c71f74e1f3c"
		)
	]
)