...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-2.1.4.xcframework.zip",
			checksum: "599d54245d7590919375cecc2fb6d0293ce036c6b04d277e0939c2807ec77518"
		)
	]
)