...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.0.0-beta.34.xcframework.zip",
			checksum: "9caaf9971809415da5e25132efce1d2cfac08c72c0bb6fcd07dd1909c182b10c"
		)
	]
)