...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.0.0-beta.25.xcframework.zip",
			checksum: "cd1394045b6e0f1bc8c83cfe79a6b526627a1841c3efc008c721b8828e49c815"
		)
	]
)