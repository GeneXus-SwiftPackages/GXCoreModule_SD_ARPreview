...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-5.0.0-beta.1.xcframework.zip",
			checksum: "c3165f4a0cc9a857dae934d0192b1340610cb73f9e8a567dbd2683a3c30f83d6"
		)
	]
)