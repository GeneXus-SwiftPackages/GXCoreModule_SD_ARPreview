...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-4.2.0-rc.3.xcframework.zip",
			checksum: "86a8943459f39ec880e28e6302a0df9ea308f251371edbfaf282caf983f41ffd"
		)
	]
)