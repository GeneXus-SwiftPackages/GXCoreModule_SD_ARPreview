...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.1.0-beta.3.xcframework.zip",
			checksum: "5b944127e7ddc809cea1a54daeafacb8d66f8fd69a965f096a31bd181c3ccda4"
		)
	]
)