...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.2.0-beta.9.xcframework.zip",
			checksum: "b388fe02191c97a4136a83a17690051304b0427a5496964345770f8492938e85"
		)
	]
)