...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.4.0-beta.13.xcframework.zip",
			checksum: "6c3deb219a99fbae3f2ec303902bbee68236585a08555123c256ff41423162e3"
		)
	]
)