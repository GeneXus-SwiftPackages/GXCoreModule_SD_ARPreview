...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.2.0-beta.39.xcframework.zip",
			checksum: "bebfe6db2c022f567a6fabf711a7ee1b3267c996b3963a86c0fae9b4e6581e41"
		)
	]
)