...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-2.1.0-rc.25.xcframework.zip",
			checksum: "883210bcb1ecec1741a2d871322d95e31021fada99630288ed52f674960d5415"
		)
	]
)