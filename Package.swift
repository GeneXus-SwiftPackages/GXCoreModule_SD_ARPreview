...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-3.2.0-rc.9.xcframework.zip",
			checksum: "4b48e92bba467ffa8924e46743facc75464119879135139be83b1b22f1cf2099"
		)
	]
)