...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.1.0-beta.25.xcframework.zip",
			checksum: "10643dce55147f5105ba779b5f8e7c0bb1c861edf6353f2a8d29ed7461201892"
		)
	]
)