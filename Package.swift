...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.0.0-beta.4.xcframework.zip",
			checksum: "3000bbeef625c3d0a7fc5f34dbfe788b6fcd047862560b40820a8d699442f63a"
		)
	]
)