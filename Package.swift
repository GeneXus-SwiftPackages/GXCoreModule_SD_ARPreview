...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-4.1.0-rc.25.xcframework.zip",
			checksum: "f44525a14a3af00477295c939c6257b975b86d11f992c228f94ef0b224936b83"
		)
	]
)