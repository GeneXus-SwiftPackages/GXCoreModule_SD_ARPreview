...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.2.0-beta.11.xcframework.zip",
			checksum: "2395e54b31044a095be998a5e0bbbfc976ae70a43fa62b29661ea0ff6f96485f"
		)
	]
)