...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.5.0-beta.20.xcframework.zip",
			checksum: "e85b6aa5c1fefd0c1a031af81552e26d4550695c6815b86f121a55880d0bdef8"
		)
	]
)