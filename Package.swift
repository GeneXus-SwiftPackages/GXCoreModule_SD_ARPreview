...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-2.0.17.xcframework.zip",
			checksum: "f9b8244b27649de60c9ca4c43a8058a31f04099244dad74c5415047800d6649d"
		)
	]
)