...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-4.1.0-rc.3.xcframework.zip",
			checksum: "9ed87052c404480a89b11e1d76c4fe9c43ae4103aa15c2b303f8cbc3433e06b8"
		)
	]
)