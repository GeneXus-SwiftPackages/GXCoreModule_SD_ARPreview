...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-3.0.7.xcframework.zip",
			checksum: "3b151cf30e53601c38dfd8e3d72091879562cb5ff8becc9c4d995b86145682ed"
		)
	]
)