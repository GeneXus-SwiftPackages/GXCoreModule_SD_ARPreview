...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.2.0-beta.5.xcframework.zip",
			checksum: "3a005c0d9dbc2ab7202fd9102257e41a7cf34d1c787a7f2a8dae67d5e8c428bf"
		)
	]
)