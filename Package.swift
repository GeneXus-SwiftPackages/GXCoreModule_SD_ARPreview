...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.0.0-beta.19.xcframework.zip",
			checksum: "de10420d499eef75fc8c7775c8054fbaa3907bc1ed2c9b65816d326ac796fba3"
		)
	]
)