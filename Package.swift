...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-4.1.0-rc.24.xcframework.zip",
			checksum: "ca09dcfecddb5e3379defb6b603bafa4900ddd6ea7289224dfb1f8ccc32e9d5e"
		)
	]
)