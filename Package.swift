...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.0.0-beta.0.xcframework.zip",
			checksum: "e196036545dfc82a1c905440fc0e79a5571ca53c170a798f619bede3f1a48c3e"
		)
	]
)