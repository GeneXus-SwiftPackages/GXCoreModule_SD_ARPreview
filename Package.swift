...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.4.0-beta.17.xcframework.zip",
			checksum: "60a9b63f463b0c0571e637aa13a0f5c3cb509aaa3db95841008c737394380375"
		)
	]
)