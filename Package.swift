...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.2.0-beta.32.xcframework.zip",
			checksum: "50a2df1630e21b0c38854f4b0061c247e063c3652db90abec37c265c3b57d4fd"
		)
	]
)