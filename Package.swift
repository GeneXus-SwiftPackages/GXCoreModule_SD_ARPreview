...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-3.0.4.xcframework.zip",
			checksum: "83edef2e2bbcac8b40ce60d667193e9dbccbfb87e8b2c9e6ba680436e9b405f2"
		)
	]
)