...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.2.0-beta.20.xcframework.zip",
			checksum: "1f7930f7843bd4ff000a6db41fca4d02ee5715fd5ccfe0adf49d410c66608108"
		)
	]
)