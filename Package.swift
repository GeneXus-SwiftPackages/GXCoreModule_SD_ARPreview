...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.2.0-beta.20.xcframework.zip",
			checksum: "67d06e23a40fd030901348ab2394ae5e5be737c135998a8d0b57ad3cb0ef747a"
		)
	]
)