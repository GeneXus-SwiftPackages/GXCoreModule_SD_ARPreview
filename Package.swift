...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.0.0-beta.7.xcframework.zip",
			checksum: "c3efbc34c057432155f1dd50c49ec1f5e75c3e9da0f9ae271b4c4753a9ddc87e"
		)
	]
)