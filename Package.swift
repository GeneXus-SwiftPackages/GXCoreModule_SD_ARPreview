...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.2.0-beta.23.xcframework.zip",
			checksum: "21b0e01a51fbc9e4e10b86b660913cd64f9f8b3130dd2a52b36d7db07d316cfc"
		)
	]
)