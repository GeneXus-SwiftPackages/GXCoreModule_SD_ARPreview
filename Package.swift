...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.0.0-beta.36.xcframework.zip",
			checksum: "0982a8cd2f0beb4bceac59cd247d452d061f5d9889f57c9ea5b984fa76fcc584"
		)
	]
)