...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.0.0-beta.2.xcframework.zip",
			checksum: "7a4ff30fe857896045405db3212ac142e7254f8986ef980ecfede13dfef5c3e3"
		)
	]
)