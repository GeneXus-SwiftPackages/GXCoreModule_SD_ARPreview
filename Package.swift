...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-2.1.3.xcframework.zip",
			checksum: "110b5338dcea2ea596503831583809a5fdb178358227dd0ed8502c6f72954f4c"
		)
	]
)