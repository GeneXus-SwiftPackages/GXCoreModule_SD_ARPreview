...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.4.0-beta.7.xcframework.zip",
			checksum: "82da1fe7425222c5ccd2053ef7ed79d96617b5998a7e7803119bedb1d94f5896"
		)
	]
)