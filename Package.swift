...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.0.0-beta.38.xcframework.zip",
			checksum: "dae80d17ac72d3803847cf10f61bed51a342b7ddd64cc0a30b607797159d5ea0"
		)
	]
)