...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-1.5.16.xcframework.zip",
			checksum: "602faf14272f3c5720d769aa8c4c81ae5b860f0adf5504a6cb87268fba7824fc"
		)
	]
)