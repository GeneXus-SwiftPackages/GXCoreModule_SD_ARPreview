...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-2.0.0-rc.22.xcframework.zip",
			checksum: "c3f4a0af807709f1e5ee7432be42f3818b5409209e959ad6248a00ea2de2799a"
		)
	]
)