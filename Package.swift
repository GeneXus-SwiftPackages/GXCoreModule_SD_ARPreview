...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.0.0-beta.17.xcframework.zip",
			checksum: "205bd2b98199e5fdb199dec10ddfbbd326ae53bb56792184c76cbc582d77597d"
		)
	]
)