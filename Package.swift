...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.6.0-beta.2.xcframework.zip",
			checksum: "dc50166638e4fbc44485458436e904516bc041e1721131dc37108e2b2f86dc57"
		)
	]
)