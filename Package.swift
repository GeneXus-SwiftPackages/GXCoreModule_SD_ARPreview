...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-4.1.0-rc.22.xcframework.zip",
			checksum: "9968fa7b3680799dd87ed78096dc9199f8d74439b5d06f7913c3bb46e7902c78"
		)
	]
)