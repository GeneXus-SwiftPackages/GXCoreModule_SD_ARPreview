...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.4.0-beta.16.xcframework.zip",
			checksum: "4336399d92ee22121271d2499cbe5d85cb51c6825feecc0731b6fd3fe21e1f20"
		)
	]
)