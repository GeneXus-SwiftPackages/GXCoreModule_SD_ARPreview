...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.1.0-beta.7.xcframework.zip",
			checksum: "2d40ff429b5d8ccbc7e917e235fcfba2edafd1da225f402957c69b84461091ff"
		)
	]
)