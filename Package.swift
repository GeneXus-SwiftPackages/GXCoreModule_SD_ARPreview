...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.1.0-beta.26.xcframework.zip",
			checksum: "78c313eb48425074a17a8c240d26d5053964b0765624d4c69f0e09613825c8a6"
		)
	]
)