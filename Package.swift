...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.0.0-beta.40.xcframework.zip",
			checksum: "8ec88d21e95ccd29db84380ae0c801cb7e83e1774b33835d4820c3210e96038a"
		)
	]
)