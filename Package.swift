...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.0.0-beta.37.xcframework.zip",
			checksum: "d638f57c05eb37fa526c64a20fe304ab1c0986e828b017d13b310a78897925ad"
		)
	]
)