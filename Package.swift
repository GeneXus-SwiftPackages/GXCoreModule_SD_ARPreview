...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-1.4.0-rc.5.xcframework.zip",
			checksum: "268ad8a9f373511a47566f8aa0e2bbf9e412bd94b4c021d9975a5579062abba5"
		)
	]
)