...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.2.0-beta.29.xcframework.zip",
			checksum: "1ce069c882f2068fcfb07d4896c5a840485a937940661d9204e747fce960c5c4"
		)
	]
)