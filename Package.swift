...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.2.0-beta.30.xcframework.zip",
			checksum: "7236e1a4c939653204d710870cea26ddc3b19fa2d58d0149efce64d771b3c618"
		)
	]
)