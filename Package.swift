...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-1.4.29.xcframework.zip",
			checksum: "1150420ab792bafe15a871b707d69855f08bc89918b8c43cfc789f6565e3d9c2"
		)
	]
)