...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.0.0-beta.12.xcframework.zip",
			checksum: "65acc0986bbe01c6886b2f7e5f39860f05cc833de5e73320d82bb6a13d71b014"
		)
	]
)