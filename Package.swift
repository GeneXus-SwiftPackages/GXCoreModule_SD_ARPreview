...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-3.2.0.xcframework.zip",
			checksum: "64fb3f7d28eb40d4c206c40075008527183e307b40236eb5d50db91d3fca34e1"
		)
	]
)