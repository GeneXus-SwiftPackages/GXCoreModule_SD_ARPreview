...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.2.0-beta.36.xcframework.zip",
			checksum: "1f05061d5d71e60617226e818f0330170cc2a0a4841f6f7c18a0dd1add562623"
		)
	]
)