...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.0.0-beta.10.xcframework.zip",
			checksum: "168532b46143242019f3ec9adf493cc07f42b1944a69f3a704e88e1c9da9c6ef"
		)
	]
)