...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-1.5.0-rc.26.xcframework.zip",
			checksum: "cfce867d6a1ae9a96fd425a0c11c02b27cc9e0c416c0d86e4222700fea95fc73"
		)
	]
)