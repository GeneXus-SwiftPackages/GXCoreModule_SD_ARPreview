...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.2.0-beta.17.xcframework.zip",
			checksum: "8b93e5269f293dd07b90dd7d563be32f0c7beec60db7bdfa8811953944e4f4e7"
		)
	]
)