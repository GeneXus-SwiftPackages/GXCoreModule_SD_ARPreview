...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.4.0-beta.2.xcframework.zip",
			checksum: "3611c21426199904c76a584db3975e582cab613598d950e224d891f1ba4c0b2b"
		)
	]
)