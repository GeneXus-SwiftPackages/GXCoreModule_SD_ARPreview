...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.2.0-beta.32.xcframework.zip",
			checksum: "971c2e2dd1473a6b22bdcb7c4d0f09b4c4c16a651f98b47385363f510eaa5202"
		)
	]
)