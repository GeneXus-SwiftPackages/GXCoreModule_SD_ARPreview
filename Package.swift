...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.2.0-beta.22.xcframework.zip",
			checksum: "08d3ea5ad8a395cfcf7a0d20e63aa1918ac9f4fd2108f6e8d62d95a303e0f8d7"
		)
	]
)