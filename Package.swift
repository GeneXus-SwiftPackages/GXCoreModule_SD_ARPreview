...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.0.0-beta.18.xcframework.zip",
			checksum: "7de62cc440bdfb7129b029bea7ddf182daba312ab78747349f126ccb8801bc3d"
		)
	]
)