...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.2.0-beta.25.xcframework.zip",
			checksum: "8043fc2ccaf0c934d15d7ec05becd669e690fd04627d70950dcde6d07a5e8796"
		)
	]
)