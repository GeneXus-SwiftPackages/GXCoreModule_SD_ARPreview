...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-1.5.11.xcframework.zip",
			checksum: "aa5b67c63cbe22b051d92bc16036cbd5d77593ed0e15ab6a7da7bca2b90852df"
		)
	]
)