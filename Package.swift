...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.2.0-beta.37.xcframework.zip",
			checksum: "72f0b0962db8f28f3f4241cc48acb0fe4a2265c7dbf5f58901a057f3dcab9814"
		)
	]
)