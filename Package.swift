...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.1.0-beta.6.xcframework.zip",
			checksum: "8c2ae031b0ab38c8862bc56f24bb2022b4273663ba8d5d607cd5169614879969"
		)
	]
)