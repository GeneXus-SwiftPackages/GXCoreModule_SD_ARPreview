...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-1.1.0-rc.3.xcframework.zip",
			checksum: "b1bb05fc852afc64ddef80c39a38e0efe0a957f978a88cdbc0d669600a0c36bb"
		)
	]
)