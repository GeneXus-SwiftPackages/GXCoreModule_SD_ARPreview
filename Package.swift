...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-4.2.0.xcframework.zip",
			checksum: "2524c81562a63a8716b4839df9709a7dfabfd54788c5c489c8343a1550a73275"
		)
	]
)