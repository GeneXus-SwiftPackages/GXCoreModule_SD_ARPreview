...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-4.2.0-rc.37.xcframework.zip",
			checksum: "b0ae28777be48b61307dc561e603c56a50c0684e71fe4b02b54b65ce35615fa4"
		)
	]
)