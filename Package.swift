...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-3.2.0-rc.0.xcframework.zip",
			checksum: "a0eb1f9978a6b383c122d8beddc1a477279e27453a53b2328e7c1a1492dbadf1"
		)
	]
)