...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.0.0-beta.11.xcframework.zip",
			checksum: "15e0f4c80c4d4fef6843b99bec077456dc664989dfc3882e0b3947566c311a79"
		)
	]
)