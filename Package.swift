...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.2.0-beta.12.xcframework.zip",
			checksum: "9e370ba5fe590f0040428f7608f368e54b0798708af83651ab9a6300e8bbc677"
		)
	]
)