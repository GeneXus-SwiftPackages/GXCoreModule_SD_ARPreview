...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-3.1.5.xcframework.zip",
			checksum: "733a7043bf0a9ea5fdc010078e6b970effc2627f12877e93abf15d31da6edd22"
		)
	]
)