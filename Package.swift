...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.3.0-beta.7.xcframework.zip",
			checksum: "8a686f3636ac869810f9e80e767735afc7669a9b2ee663960a445d639bdeff8b"
		)
	]
)