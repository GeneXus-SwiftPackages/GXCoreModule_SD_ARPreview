...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-1.2.0-rc.36.xcframework.zip",
			checksum: "b41e67adde073988f1ef73fbdf1e31ef1a949ce6072074e13128cf8d562bbeb6"
		)
	]
)