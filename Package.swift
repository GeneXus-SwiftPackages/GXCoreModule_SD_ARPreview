...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.2.0-beta.15.xcframework.zip",
			checksum: "ccad124087a183738a2d69e56367d781e8079ef7552c18bbe68de6f81a1b5689"
		)
	]
)