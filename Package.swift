...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-5.0.0-rc.1.xcframework.zip",
			checksum: "231cf8b831e2c37fcfabac0f2664c31575c543757e7b54a9ec47e84e2080302e"
		)
	]
)