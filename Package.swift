...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-1.3.0-rc.13.xcframework.zip",
			checksum: "52ac06b8b011784b69ed8004a7be67b00b8ec0d47f1937de0375f1ed3b872ea8"
		)
	]
)