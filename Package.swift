...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.2.0-beta.1.xcframework.zip",
			checksum: "ad0c3b3289d9672c783bcffaf1fca06b380ef69a4096225c117be38cb418f4ec"
		)
	]
)