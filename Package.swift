...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.4.0-beta.6.xcframework.zip",
			checksum: "344dbe519a7ff09228d588d7492fa6b70fbaa8b7b0e346d39177e29d4f96f1c8"
		)
	]
)