...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.2.0-beta.37.xcframework.zip",
			checksum: "cd38702e5d551ca170de2651484af3e0bcf6e45adb1ac60452975f3d92fc8ad1"
		)
	]
)