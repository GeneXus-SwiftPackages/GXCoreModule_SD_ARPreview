...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.0.0-beta.17.xcframework.zip",
			checksum: "d855fd9da1345f81e5036f40a9dc7d2a0ac9149b459c6e7985da7e7da28365d1"
		)
	]
)