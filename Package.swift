...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.2.0-beta.33.xcframework.zip",
			checksum: "1ac5d087ec26d0ba5fc266ead696441a2cc04886de877fc5a5f76c9e6117c912"
		)
	]
)