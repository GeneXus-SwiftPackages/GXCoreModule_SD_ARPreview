...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.2.0-beta.23.xcframework.zip",
			checksum: "1f07ea580ffcbcd996ecc71be3a63e33cb5926df55b58dd7565e3fa2c6445606"
		)
	]
)