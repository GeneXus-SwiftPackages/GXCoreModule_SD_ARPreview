...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.3.0-beta.9.xcframework.zip",
			checksum: "cdafa48d1a8651a876cba1892c033b0b1c834931cf0328a58ff2fb6aefa3ab7d"
		)
	]
)