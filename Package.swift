...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.0.0-beta+20230504180356.xcframework.zip",
			checksum: "dedfccbbd1fe46d85d82ced4f7f8c5b25a2c83e59a2f4f03e9427a271eaaacfa"
		)
	]
)