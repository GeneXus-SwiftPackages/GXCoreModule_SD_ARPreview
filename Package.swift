...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.4.0-beta.4.xcframework.zip",
			checksum: "c9c0abad9efdcf7191d3b44fddaaf43f9e3d201f3cdd8a6c265fe424ed286290"
		)
	]
)