...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.0.0-beta.35.xcframework.zip",
			checksum: "f43253a425827f86e851d38840a41c5860f46899cdabacc7ec5ee312bfdd6efd"
		)
	]
)