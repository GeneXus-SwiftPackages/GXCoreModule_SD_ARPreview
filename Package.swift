...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.0.0-beta+20230609175617.xcframework.zip",
			checksum: "6f56f4cfc38a46ad6fc06974c7c132907a18b427a0dab6cd580824b4cbb3b4a0"
		)
	]
)