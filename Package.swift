...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-2.0.0-rc.36.xcframework.zip",
			checksum: "9810651bddcfa20dcdf40e8ffabe8cdaf748e3a6598d222627b06abe68f35298"
		)
	]
)