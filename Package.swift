...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-4.0.5.xcframework.zip",
			checksum: "55ce5a3fa871a157ad450c09bfa4ce337d857b2b666f7bdaea0a2807c42bc423"
		)
	]
)