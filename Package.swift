...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.5.0-beta.27.xcframework.zip",
			checksum: "b6cd8edf52028852908d58501fcfe22f91885b476567d99e343fea3ff32a70aa"
		)
	]
)