...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.2.0-beta.14.xcframework.zip",
			checksum: "bb3642fdfbdb68daab2ff49c40f2694d07a6845a07baf43d12ba4ca51d796a12"
		)
	]
)