...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.3.0-beta.5.xcframework.zip",
			checksum: "bca410d48e39694540b572cce3efc77f0bffb5cee3fd4d7d0bd28604656a90b3"
		)
	]
)