...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.0.0-beta.47.xcframework.zip",
			checksum: "eaa4312afc654f8615b518cdd4270adcdd7908f2dd60fc08321ba045a35f488f"
		)
	]
)