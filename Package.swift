...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-1.4.26.xcframework.zip",
			checksum: "49ee071da373f07142952264ce893633ddad2bf7012d200b8c3206ad4dc52f7f"
		)
	]
)