...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-5.0.0-beta.4.xcframework.zip",
			checksum: "31f37d80c31f7e4d8d82404a601b2d81bd9a8cee3ee015f6df32af1bf8192548"
		)
	]
)