...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-4.1.0.xcframework.zip",
			checksum: "70b056ac3ee074f2fc609bf7f51a35660664f62af19974872188110e7d16a18a"
		)
	]
)