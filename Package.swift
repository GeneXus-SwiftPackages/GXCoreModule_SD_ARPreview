...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-1.3.5.xcframework.zip",
			checksum: "3451ca325bced96777d2e03d3d52ad78a68976c510d18f9f1d4864c16e6521b2"
		)
	]
)