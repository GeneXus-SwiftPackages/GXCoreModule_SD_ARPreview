...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.1.0-beta.19.xcframework.zip",
			checksum: "b037cd8d8a953566c831fba728ecdc1a37ac19487d90389dfcd1d32af4cb08d0"
		)
	]
)