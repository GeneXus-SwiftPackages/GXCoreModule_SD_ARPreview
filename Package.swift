...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-1.4.30.xcframework.zip",
			checksum: "f333c34005868bd8cf16a70043e2988f03ad0013180a8269c0694c3257f8423f"
		)
	]
)