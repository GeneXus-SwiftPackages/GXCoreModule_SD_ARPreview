...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.4.0-beta.5.xcframework.zip",
			checksum: "f3ddbbb75fe0d75b5cfc126f06de4dd9cc24e6d89a6c1663e830f1a02df4b1e8"
		)
	]
)