...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.2.0-beta.30.xcframework.zip",
			checksum: "25dea7971184cb3934bd5f09d32166af3e33d96a9b2899d811e7f88b74c94cff"
		)
	]
)