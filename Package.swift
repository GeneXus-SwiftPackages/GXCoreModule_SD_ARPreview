...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.2.0-beta.27.xcframework.zip",
			checksum: "693f85156f533d1df4dcd5c33d93901e660a648118f4c881386b2ccf2e947945"
		)
	]
)