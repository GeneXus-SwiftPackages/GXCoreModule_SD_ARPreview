...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.4.0-beta.20.xcframework.zip",
			checksum: "ccde6e7349ce32a847be79d67b1d0d38d7d9fbeb0894d25905df4d6912034eb1"
		)
	]
)