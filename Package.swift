...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-3.0.0-rc.15.xcframework.zip",
			checksum: "4b5c26c78f5ba57917603fb7f8a604176fcb7f2e1dc1bd665b9c4ba7aac1f1dc"
		)
	]
)