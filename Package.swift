...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.2.0-beta.16.xcframework.zip",
			checksum: "8f1cf2f7d6b647522560f7485b6d964611683475362380d2fbb729ddd40ce5e8"
		)
	]
)