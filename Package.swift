...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.1.0-beta.2.xcframework.zip",
			checksum: "507ad6823460411e1c8b67912c968be9ea60223ac8ddfbbc97c5353e10aa00fc"
		)
	]
)