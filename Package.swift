...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-4.0.8.xcframework.zip",
			checksum: "69799e90a6fe87c8974309b1a01fe68f0acb022c659549565b12fd3284c668cd"
		)
	]
)