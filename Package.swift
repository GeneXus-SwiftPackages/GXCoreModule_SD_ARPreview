...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.2.0-beta.24.xcframework.zip",
			checksum: "3f58467b4ee44f5d7779b3c462b48ab8c99c433ef1e0f8203ac36c7c79b6afd2"
		)
	]
)