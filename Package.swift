...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.0.0-beta+20230509173316.xcframework.zip",
			checksum: "9e2d8203661dc68281002a02b29f0e0dd740bcb29f6e3c4ae5ffcd0c6014db9b"
		)
	]
)