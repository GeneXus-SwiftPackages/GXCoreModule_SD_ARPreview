...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.1.0-beta.18.xcframework.zip",
			checksum: "1a404fb4b2a332b366cf97e60d68c1fef1717836bb08fadeaa13dbe9389324b5"
		)
	]
)