...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-1.1.0-rc.4.xcframework.zip",
			checksum: "3d0b0479fb9a19d742d2aff62b8aa28d48cba1e71db8c759e07b7492bd7ceb5d"
		)
	]
)