...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-1.5.0-rc.2.xcframework.zip",
			checksum: "3e2f8a39b4b52326fdb260f220414d3f41896a95f259122129995891bab007e0"
		)
	]
)