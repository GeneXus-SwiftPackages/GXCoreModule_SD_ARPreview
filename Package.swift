...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.2.0-beta.17.xcframework.zip",
			checksum: "80580fff6d770749f56a917cb2807095fd6c30debcadb2d775001e607c6913d2"
		)
	]
)