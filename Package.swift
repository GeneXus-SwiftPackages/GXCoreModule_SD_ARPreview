...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.0.0-beta.14.xcframework.zip",
			checksum: "f9f6f0ce5cacede5d4b5b1c7077117f4a9637fff0ddae17d866eef7ae2f27865"
		)
	]
)