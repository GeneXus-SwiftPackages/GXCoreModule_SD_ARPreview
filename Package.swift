...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.2.0-beta.20.xcframework.zip",
			checksum: "059b37445b9609eb69dbef1b01fea8fb70a0fa25c722dafa80de4292cfc1609c"
		)
	]
)