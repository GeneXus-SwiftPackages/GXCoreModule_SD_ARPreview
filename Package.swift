...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-2.0.12.xcframework.zip",
			checksum: "a2abb5e09ac5ca7a7accfa453e5ea6f3ab953874d8ee6e228424eb81098a5b6f"
		)
	]
)