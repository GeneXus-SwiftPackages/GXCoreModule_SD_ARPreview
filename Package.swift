...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.1.0-beta.24.xcframework.zip",
			checksum: "6e6d0f6ad1e4e36ddd1d339db6779ec8fc13c3a21c553c1139c187c85e35a3dc"
		)
	]
)