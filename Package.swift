...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.0.0-beta.20230710220444.xcframework.zip",
			checksum: "dc4aa8dbdacf9a81557809ecd7f28f49c6ce3a942b6cbd4bdf2dccdc055ea242"
		)
	]
)