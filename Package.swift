...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.1.0-beta.26.xcframework.zip",
			checksum: "a42617560372e2d7feefea1b01c2afff3455e8185c0bd70b2b10cbb28fccf135"
		)
	]
)