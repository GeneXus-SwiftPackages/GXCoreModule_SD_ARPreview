...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.2.0-beta.18.xcframework.zip",
			checksum: "004194c7c19ace03237dae99754053bf32055856870327fb7b0d5194b1799e24"
		)
	]
)