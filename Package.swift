...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.5.0-beta.13.xcframework.zip",
			checksum: "7ecf1a08f1542d4a7cc62da454461cd83f648c49821812e555f6c5d6dbbab6de"
		)
	]
)