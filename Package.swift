...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.0.0-beta.33.xcframework.zip",
			checksum: "2147b0892b6fcb216955b4cb9427d71063107b7949981a6cf43834502b531f6f"
		)
	]
)