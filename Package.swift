...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.5.0-beta.12.xcframework.zip",
			checksum: "02794de77a5a6e84609d1d0c2a1a0d374dc44634f3c199a0ca94c50a15f0fe6b"
		)
	]
)