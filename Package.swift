...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.1.0-beta.794.xcframework.zip",
			checksum: "ffea5448b98b32139ff6720b97f969f2bc82be3910a140e404fd0c5c82992b43"
		)
	]
)