...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.2.0-beta.33.xcframework.zip",
			checksum: "e79f8daf2cc46c0e9f42534525659c882d4d062170d72dfa2bc8671eac92341a"
		)
	]
)