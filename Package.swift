...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.0.0-beta.16.xcframework.zip",
			checksum: "832456e178fbd685d9a06244c9ad4707d8135066bb9437588c39176a1a342334"
		)
	]
)