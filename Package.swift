...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.1.0-beta.0.xcframework.zip",
			checksum: "c04d0aa6343ec29b10e7eb2d2be10f04ca9df688dacc54628cf07baf0e5eebc3"
		)
	]
)