...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-4.0.4.xcframework.zip",
			checksum: "1225f0cf90340d352d55c03a7a4913de4305b94522bb7a0351a56897c9d5c59c"
		)
	]
)