...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-1.2.0-rc.25.xcframework.zip",
			checksum: "3ac0c4800e2870d63866e4f72991587405b5dbf1c32bc25330ba2c2ab0627afc"
		)
	]
)