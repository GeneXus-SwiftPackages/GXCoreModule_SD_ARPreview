...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-1.5.17.xcframework.zip",
			checksum: "154c6616ac9f520bb1db4ca7d942f395e0b2c070022e2805b8348ed6253c06bc"
		)
	]
)