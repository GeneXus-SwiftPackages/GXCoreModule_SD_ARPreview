...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.2.0-beta.10.xcframework.zip",
			checksum: "2992ad617cff5e681d1048805fe31671c448898aa9ceec84240736ceb93b9738"
		)
	]
)