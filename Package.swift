...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.1.0-beta.12.xcframework.zip",
			checksum: "1119476741fc0e198073da008ffeac93f9b0e88cd59749598f6ac76a39575ca3"
		)
	]
)