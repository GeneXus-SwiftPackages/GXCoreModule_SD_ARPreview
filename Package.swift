...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.0.0-beta.41.xcframework.zip",
			checksum: "b35ee4b242bc0ab4c3aaaaddec87a26465a39b317e11eb3718ddc3011772d7e9"
		)
	]
)