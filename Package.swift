...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-4.0.6.xcframework.zip",
			checksum: "afb28ce9eaedab33313526e7819f713e28f6e63deeea462faf69ae27b0134328"
		)
	]
)