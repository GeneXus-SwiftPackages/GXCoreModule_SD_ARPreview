...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.5.0-beta.11.xcframework.zip",
			checksum: "ff160a91837d38d620c3fa806de7e2013c77eddff7d4644ecd41f067ba1af96f"
		)
	]
)