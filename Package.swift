...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-4.0.17.xcframework.zip",
			checksum: "6ef7608483f255efa2aaa55f512df6f42dd2662a6b4101ff553b39fd416e72ee"
		)
	]
)