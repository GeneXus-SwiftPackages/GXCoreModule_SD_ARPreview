...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.0.0-beta.31.xcframework.zip",
			checksum: "16ed5811d0eaa0e92168fc80678264b789656fe4fdc39ff04fbdcb96331a0bb7"
		)
	]
)