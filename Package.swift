...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.1.0-beta.20.xcframework.zip",
			checksum: "6f20484a43291e654d1979632d8f21e61056c68091d6fa06d289df9c7767d993"
		)
	]
)