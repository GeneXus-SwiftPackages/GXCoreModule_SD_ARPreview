...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.4.0-beta.3.xcframework.zip",
			checksum: "7dd1f2fd7d047c213417343b0e3760363d87b707bb6d04d12984ddb40f169012"
		)
	]
)