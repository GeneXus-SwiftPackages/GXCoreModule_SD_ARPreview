...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.1.0-beta.1.xcframework.zip",
			checksum: "d310ed894affca5f5452ffa95bb5f195fd4b07b9daebc2ea222b30f99d332ac2"
		)
	]
)