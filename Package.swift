...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.0.0-beta.15.xcframework.zip",
			checksum: "8d0046e7322070cb0ef3a1fc5fcc89d8e57209029bb053cbf294264a7f39543c"
		)
	]
)