...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.0.0-beta.20230630183632.xcframework.zip",
			checksum: "d05025e288b1d82eadb05cdf204b4beaf467627c4f27f951f0f86a92a4c438ba"
		)
	]
)