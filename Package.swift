...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-3.1.0-rc.8.xcframework.zip",
			checksum: "572c59ad220b39804e6cc714ddbe12ebed5f94ebe199978b4d6ccfb6c0b6ad93"
		)
	]
)