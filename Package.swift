...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.2.0-beta.17.xcframework.zip",
			checksum: "f9475375ed5497da8215b7492edfaf6bfc80726107a523d7ff986de142ad2025"
		)
	]
)