...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.2.0-beta.25.xcframework.zip",
			checksum: "19079019ddff37814f30a8dfc6154557f13796d424d3a968861369f660ede43f"
		)
	]
)