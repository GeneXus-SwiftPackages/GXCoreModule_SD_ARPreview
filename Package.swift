...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-4.1.5.xcframework.zip",
			checksum: "68c37c15bc2bb0bed13c37e9e94bc45e4daf9afc918944b55ab2c596564c66da"
		)
	]
)