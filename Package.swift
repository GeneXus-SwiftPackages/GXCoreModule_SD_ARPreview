...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.1.0-beta.10.xcframework.zip",
			checksum: "5531537bea8f290806641d2d34edf89b23301d5f35affa31cf9e4e7396c1e20f"
		)
	]
)