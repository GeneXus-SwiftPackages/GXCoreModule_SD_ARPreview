...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.0.0-beta.51.xcframework.zip",
			checksum: "339ec426a151a22cacc81b5206ffe895d57f4b5d6076cd7a58a7d7f7415a3966"
		)
	]
)