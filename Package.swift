...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.5.0-beta.9.xcframework.zip",
			checksum: "66d69c4ba8c9a74b1f4394bf01aca2008a2e4b09729dea3f0379837521cd34c4"
		)
	]
)