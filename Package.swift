...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-1.4.0-rc.21.xcframework.zip",
			checksum: "ffa79b6741c778a3ee067b4127af81186f2bea01e888300e84cd13a33f7b1b4d"
		)
	]
)