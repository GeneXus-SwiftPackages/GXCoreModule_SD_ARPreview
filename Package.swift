...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.0.0-beta.6.xcframework.zip",
			checksum: "335d5b77b84391470543b9187723756a31589ee04a2a92069ee25b65ace17063"
		)
	]
)