...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.1.0-beta.15.xcframework.zip",
			checksum: "afb5e725e544805b8c249468242c837cfabf6d29c938d4212eeee42f8a525a8f"
		)
	]
)