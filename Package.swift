...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.0.0-beta+20230518171417.xcframework.zip",
			checksum: "0592b0ccb6093a909017ca4b246d046c551083bfc6bc409e852b766dd3d5bd16"
		)
	]
)