...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.4.0-beta.14.xcframework.zip",
			checksum: "cb5ac0e43140168ab1e7559de7f53b834d5d48919e046ea343570f35c5fcd708"
		)
	]
)