...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-4.1.3.xcframework.zip",
			checksum: "2d2a2503727092bf59b9e59c985aca0e321ed5e4ba57aef74f49918bc6ab99d4"
		)
	]
)