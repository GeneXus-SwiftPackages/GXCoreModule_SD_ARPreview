...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.5.0-beta.24.xcframework.zip",
			checksum: "be7e8f2ebb06f2766759e218b58270e835cacc8b926e535e518a10990c06183e"
		)
	]
)