...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.2.0-beta.35.xcframework.zip",
			checksum: "64fb170db7f8b6654e7c2516e4513806cf235c81e42c533f3d8f66f31bbfb9f1"
		)
	]
)