...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.0.0-beta.23.xcframework.zip",
			checksum: "7c3d93549299c903fba7d3bf1e108044d49520225fc3351e7ea500f9ce25656f"
		)
	]
)