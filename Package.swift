...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-1.3.0-rc.1.xcframework.zip",
			checksum: "60056355796c150d46c9976be2459411a14be6ed83cd4264431293a5cd978c93"
		)
	]
)