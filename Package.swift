...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-1.1.0-rc.5.xcframework.zip",
			checksum: "2a5df304c350adde789ba23043aaa9e6e04a601e4c7e8a99026b30166ada70c4"
		)
	]
)