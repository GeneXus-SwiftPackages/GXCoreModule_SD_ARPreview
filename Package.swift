...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.0.0-beta.27.xcframework.zip",
			checksum: "31b11294bb5d5b9101adf3eded1a1ac4a065c5581587fcdea56f2f57d84b16f0"
		)
	]
)