...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.2.0-beta.24.xcframework.zip",
			checksum: "c157ca957ab46e07edf82af901ece93adcd0b0529d343be1ae3e389d2451f8ba"
		)
	]
)