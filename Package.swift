...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.1.0-beta.9.xcframework.zip",
			checksum: "ab29b5cb510d07a79cfc9e2b9b5320f9cdcaa17fa0695e8c1be513d8a919b4eb"
		)
	]
)