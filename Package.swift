...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.0.0-beta.32.xcframework.zip",
			checksum: "03eb62c6fa31020fb7da661c60f242b85e94df68ac09cbaf52b84894c5156fbb"
		)
	]
)