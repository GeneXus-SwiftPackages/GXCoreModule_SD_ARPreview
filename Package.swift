...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.5.0-beta.10.xcframework.zip",
			checksum: "f0d72f1bcdaac3d472bc21992c755548010aef82c734dfc79704fa12896b6c45"
		)
	]
)