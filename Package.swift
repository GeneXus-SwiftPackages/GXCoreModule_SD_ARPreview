...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.2.0-beta.30.xcframework.zip",
			checksum: "9d359d196b481df3e3221bd7c90d12529b6c2fd66f67339370fd78d21b649c80"
		)
	]
)