...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.0.0-beta.9.xcframework.zip",
			checksum: "171ef29cc130e6d2d3437781a84161b795e9c93dc76f325349e590daa28a5623"
		)
	]
)