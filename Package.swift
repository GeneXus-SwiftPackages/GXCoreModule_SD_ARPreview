...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-4.1.0-rc.8.xcframework.zip",
			checksum: "a48bb89ec332c80f946526529c703f27d17fe4fcabe0ce1e503fb0328efdba9d"
		)
	]
)