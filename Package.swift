...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.1.0-beta.8.xcframework.zip",
			checksum: "799760123de5ba0c2ecd84bf88df37b771bbe534043b394f3a4d948053e829a4"
		)
	]
)