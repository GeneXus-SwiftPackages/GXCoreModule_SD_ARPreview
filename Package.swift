...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.3.0-beta.3.xcframework.zip",
			checksum: "19d6e264b28a5a9c3b132a060b174131a18625d98bd5e38642ee1a47f367efa2"
		)
	]
)