...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.5.0-beta.16.xcframework.zip",
			checksum: "98599ee59ebd871efa55b185b8eeb6ec7d72bb5b2401ea4ddbd70f9d55e3a8b4"
		)
	]
)