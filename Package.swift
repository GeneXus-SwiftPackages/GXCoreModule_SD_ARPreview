...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.2.0-beta.9.xcframework.zip",
			checksum: "de98b1fb6a65458150927a9d357c2a823f1de5651747ada4b9e3992a47ef54ae"
		)
	]
)