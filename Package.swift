...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.2.0-beta.38.xcframework.zip",
			checksum: "c144130ca14d9cd1432e1773d7d31b8d4b6af02636bfdade3764735b8f86a897"
		)
	]
)