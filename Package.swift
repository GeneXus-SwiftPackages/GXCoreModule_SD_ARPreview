...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.1.0-beta.12.xcframework.zip",
			checksum: "cc435713abad0df31f5ddedead0a46c2faa632861b77aec03e780ee000e67107"
		)
	]
)