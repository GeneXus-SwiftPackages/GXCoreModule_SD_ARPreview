...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.3.0-beta.11.xcframework.zip",
			checksum: "a39c90e92113f5d6379dc1c986dbf1c731f12a05ae196c5003aeda91e51e4de5"
		)
	]
)