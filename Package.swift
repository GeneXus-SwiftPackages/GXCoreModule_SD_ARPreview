...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.0.0-beta.45.xcframework.zip",
			checksum: "a48634cfc632bd0e9107d5d3d9d1163bd4d16be8db02a4ef06ab2ee60566c218"
		)
	]
)