...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.2.0-beta.18.xcframework.zip",
			checksum: "c86f2a0fb0575ef793cde06393349c65c10823a5b0283ced5191b81d824c1dbc"
		)
	]
)