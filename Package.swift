...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.0.0-beta.21.xcframework.zip",
			checksum: "9de9842e1960d57d269404c3755e4528dea98461937aef9f1dcdac0a58267d4a"
		)
	]
)