...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.1.0-beta.22.xcframework.zip",
			checksum: "0b343ae343cf2fc376a93173bd2b2b4cd6356e01fb3526ac61b4bea81cca8f81"
		)
	]
)