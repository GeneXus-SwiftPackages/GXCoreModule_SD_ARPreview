...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-1.4.0-rc.1.xcframework.zip",
			checksum: "4ec87310384643c3e29ed8b9fb9a1b0daa30725fe0723eedd9d9e20104fa7904"
		)
	]
)