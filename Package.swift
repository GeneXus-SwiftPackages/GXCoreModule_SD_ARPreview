...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-3.1.4.xcframework.zip",
			checksum: "3d8c52f26b19f0abfac83ed9e1cc1cf0558bcc7f171a57677338a82bd6e0ba6a"
		)
	]
)