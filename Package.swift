...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.1.0-beta.27.xcframework.zip",
			checksum: "f7d8e12643f7c91dfb84b3208fcf8d1d6f00ba6deeb077f500c4dc0b144dcc8f"
		)
	]
)