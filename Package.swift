...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.1.0-beta.13.xcframework.zip",
			checksum: "26fdb18b52163ba58be09c0d55f72c229acd62d69aed27bd4d6fd6f06c97945b"
		)
	]
)