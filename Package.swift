...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-2.0.0-rc.32.xcframework.zip",
			checksum: "e5014783f75d040626bed93cd9dd2df806668a99e8df82e841f76319b63a332d"
		)
	]
)