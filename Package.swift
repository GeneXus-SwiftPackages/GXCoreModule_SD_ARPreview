...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.5.0-beta.17.xcframework.zip",
			checksum: "0fde7642bb9b14d21684b2b6e58d991e54ef8b7233e5383cb7443066f6988af5"
		)
	]
)