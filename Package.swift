...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-4.2.0-rc.0.xcframework.zip",
			checksum: "b0f1c03d8fc04d3f0ad02c5bf9dbe7698704b696e9b26e823ec640e5b2cc6beb"
		)
	]
)