...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.2.0-beta.13.xcframework.zip",
			checksum: "af992b4ebe047b7ff2b2ce7bc07798b95087a112e3153422bbd32bf8335ad821"
		)
	]
)