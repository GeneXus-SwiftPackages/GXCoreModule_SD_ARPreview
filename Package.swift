...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-4.0.16.xcframework.zip",
			checksum: "21229b372e66722b78eb49b0e31883719aceed2f27c70a67f499145f858b1ca3"
		)
	]
)