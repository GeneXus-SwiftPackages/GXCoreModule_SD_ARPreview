...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-4.0.7.xcframework.zip",
			checksum: "684294876c05da1270693fcb9078a2c73f735a38d582a7a630917d7c3f770825"
		)
	]
)