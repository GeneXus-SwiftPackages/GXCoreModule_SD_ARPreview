...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.2.0-beta.21.xcframework.zip",
			checksum: "90936b50b9abd1586fcfefc86a39e3cdab65f2f0de783725ebbe72e454537982"
		)
	]
)