...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.1.0-beta.10.xcframework.zip",
			checksum: "498e0228cf7a615d5ba86581890356e05d2815e1ce5aa82d8e357c5ce0959e18"
		)
	]
)