...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.5.0-beta.5.xcframework.zip",
			checksum: "fd836d09dc544e862e53637da578d30ec3be1528e2ed86a90b80ff093818ddfe"
		)
	]
)