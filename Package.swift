...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-4.1.0-rc.14.xcframework.zip",
			checksum: "1647728656f9faaeb7e2591d75c38e62755f8bec7606ef820e193a5676836a47"
		)
	]
)