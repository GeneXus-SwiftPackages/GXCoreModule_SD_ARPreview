...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.0.0-beta.26.xcframework.zip",
			checksum: "700079882626288d4e757dd3eb7c952a2376f9eef239480e5ead189302c435fa"
		)
	]
)