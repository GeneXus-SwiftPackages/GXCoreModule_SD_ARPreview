...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.1.0-beta.24.xcframework.zip",
			checksum: "ed70ec7b80f537ee8d7cc6cc24b08856f23d1bc14c23881de34719c3d7f348d1"
		)
	]
)