...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.5.0-beta.18.xcframework.zip",
			checksum: "447e01104d923f5cc9ec296b437321d0f25e1c85349bbd7eae560b755dfd3dbe"
		)
	]
)