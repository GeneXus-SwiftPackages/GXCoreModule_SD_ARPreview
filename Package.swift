...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-1.4.0-rc.10.xcframework.zip",
			checksum: "f5635a529ee37923bb7dee900560cedf780c3cd08f90b00c85dbad37f4a413f7"
		)
	]
)