...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.2.0-beta.10.xcframework.zip",
			checksum: "c6001fe4adeb51fa4e014f658ae263fe6f3de198ff243c92d22d097a6b28bcbb"
		)
	]
)