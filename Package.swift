...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.0.0-beta.29.xcframework.zip",
			checksum: "9625b1c49dd0d30c566e0ea08137bdbebd31141ac8823e4c1d69528c5189750b"
		)
	]
)