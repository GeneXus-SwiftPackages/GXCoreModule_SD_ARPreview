...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.2.0-beta.15.xcframework.zip",
			checksum: "356f75d61d9a34ba46898c2ecbfb333f5de9e66d283a926ebeb78020acf68fdd"
		)
	]
)