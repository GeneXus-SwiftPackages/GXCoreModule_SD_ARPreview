...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-1.1.0-rc.1.xcframework.zip",
			checksum: "fa14465d11aa831079d1b02021b29ae5a35c258fd8d33a984d4347f446d1097c"
		)
	]
)