...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.2.0-beta.31.xcframework.zip",
			checksum: "2bf4804d0e4d70904103e880369323f15c5f1e41a61b8f52c19fd263b7315695"
		)
	]
)