...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.1.0-beta.21.xcframework.zip",
			checksum: "fad61ca9fea545c07e313b21692ccecf50e458a410a5ade453de7ec0eb5b562c"
		)
	]
)