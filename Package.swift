...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.2.0-beta.38.xcframework.zip",
			checksum: "286a84d1b7ceb24cd052aedd0cde253b1ffe853c014888b218c78026eeb405b4"
		)
	]
)