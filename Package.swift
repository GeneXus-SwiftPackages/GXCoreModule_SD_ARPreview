...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.1.0-beta.8.xcframework.zip",
			checksum: "1a8a9640f30f426a91ebc8c9dab13c2352623a3da7669030c2213c6262a4d5d5"
		)
	]
)