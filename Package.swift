...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-2.2.0-rc.3.xcframework.zip",
			checksum: "ee4f10b8e926f4c1a4a3223248674531dfd2691c0ca24b0bdc1640cb13ea99e1"
		)
	]
)