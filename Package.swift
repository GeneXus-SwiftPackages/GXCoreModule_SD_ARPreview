...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.1.0-beta.10.xcframework.zip",
			checksum: "62f9f06e41a8439509121bf9cc6aa2dbad7c6a58e0edced339dbdea7c4877a5a"
		)
	]
)