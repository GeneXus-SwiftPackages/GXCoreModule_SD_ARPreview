...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.1.0-beta.8.xcframework.zip",
			checksum: "db07397f3523fecd1fee15de2827d2be665ec8f56ffad9db6d0667d316f7093d"
		)
	]
)