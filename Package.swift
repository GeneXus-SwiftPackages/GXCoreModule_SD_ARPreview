...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.2.0-beta.14.xcframework.zip",
			checksum: "fa5f101df6823984c1be607fd26d348770a8e2997b1a1df9bc21cd6864ea98e0"
		)
	]
)