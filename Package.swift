...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.1.0-beta.795.xcframework.zip",
			checksum: "989ddca1d17ddc285fc14cd029bf44a5b0e895aaaf3fb4088524955da8b7ec94"
		)
	]
)