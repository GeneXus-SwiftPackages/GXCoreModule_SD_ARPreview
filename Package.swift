...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.1.0-beta.9.xcframework.zip",
			checksum: "41e6a379d714a7d1c3f92da2c0d47cac9677498262442ac72390f27f752eecc2"
		)
	]
)