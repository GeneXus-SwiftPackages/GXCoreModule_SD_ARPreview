...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.2.0-beta.34.xcframework.zip",
			checksum: "4ec3dada9d27fd17ff4390050175e7bd9020e7c530711cf91cce43978cae6a7c"
		)
	]
)