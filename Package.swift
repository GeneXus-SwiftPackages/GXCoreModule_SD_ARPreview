...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.0.0-beta.20.xcframework.zip",
			checksum: "6a0c70ad0a8df53e5eab9d1f1c5f6e047f9ad0af931f8e0887d7ffafce68bba8"
		)
	]
)