...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.0.0-beta.44.xcframework.zip",
			checksum: "b37e19277bfff6dd0e96657f503554b6038a6ff2e78fc49522dbe1966173ed61"
		)
	]
)