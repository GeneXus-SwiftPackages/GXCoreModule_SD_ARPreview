...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.2.0-beta.11.xcframework.zip",
			checksum: "3aa968ba83dd81a073249ea1450b1e3bbf4a8508615bbb4103facc580082d798"
		)
	]
)