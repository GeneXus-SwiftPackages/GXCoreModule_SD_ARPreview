...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.1.0-beta.25.xcframework.zip",
			checksum: "47fb665a16338e2cb8c3489a5e652a139be344bba1f0be03d611e3505a7a165e"
		)
	]
)