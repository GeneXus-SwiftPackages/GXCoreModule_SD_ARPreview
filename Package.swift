...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-3.0.0-rc.2.xcframework.zip",
			checksum: "3d025f007ee0316d60c6875cd53b89b78222ebf31a95d178023d12edf5d35454"
		)
	]
)