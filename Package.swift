...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.6.0-beta.3.xcframework.zip",
			checksum: "0f052a27c34aed47011eab9268d838377c311de64e07eca8c90f9925dd204d05"
		)
	]
)