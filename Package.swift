...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-3.1.0.xcframework.zip",
			checksum: "0d78e97602e8c4b3477b1156581a61d5201a6eab54da3727fe6fdc667c764172"
		)
	]
)