...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.2.0-beta.25.xcframework.zip",
			checksum: "2b5a3f50a0efeab07f048d6c8955d8bce763888b7a268fc900df9265716a9780"
		)
	]
)