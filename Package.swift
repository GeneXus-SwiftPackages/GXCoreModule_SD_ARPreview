...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.1.0-beta.15.xcframework.zip",
			checksum: "cda14d677d2023ae80f0e3e4571d3ce9475bc9cca0973a2e663a6ee52ca47e66"
		)
	]
)