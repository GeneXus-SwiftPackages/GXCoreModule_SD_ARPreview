...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.6.0-beta.4.xcframework.zip",
			checksum: "aa862c3ced0df65088cece785c970e4a577cb9bd526cd30c3d728ae14e9b5304"
		)
	]
)