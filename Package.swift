...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.0.0-beta.24.xcframework.zip",
			checksum: "234c8563a6c635fc19e2c6195ec3b70948a2ddb949be694e0a405ba97cd1c4a4"
		)
	]
)