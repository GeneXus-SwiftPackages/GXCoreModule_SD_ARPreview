...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.3.0-beta.8.xcframework.zip",
			checksum: "8fcc72a5c92d70da7932d43d826056a455bb537fe1a550759505b35df9925896"
		)
	]
)