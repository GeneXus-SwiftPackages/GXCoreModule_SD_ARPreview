...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.2.0-beta.27.xcframework.zip",
			checksum: "03a34ff821cadf53e5b70d3c622bb9aaa0dfdb8c8aa89f8cf240eb2ede7be51c"
		)
	]
)