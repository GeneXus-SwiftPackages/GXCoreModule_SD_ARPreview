...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-5.0.0-rc.0.xcframework.zip",
			checksum: "1c770618096101f936f1d95e5e1235b7042aa287f93977d83b2c96463a1c9516"
		)
	]
)