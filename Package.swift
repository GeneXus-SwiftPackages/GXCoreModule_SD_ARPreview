...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.1.0-beta.6.xcframework.zip",
			checksum: "0d3bf458f6b16c40260a24e7407b5ebad4dbcdac84a006f84dce5cd29ef990fd"
		)
	]
)