...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.2.0-beta.27.xcframework.zip",
			checksum: "26188ca01621f6d67e0b30ba43c4bce14913e3019259612efc797863f3d1e679"
		)
	]
)