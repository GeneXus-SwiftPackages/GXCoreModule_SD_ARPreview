...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.2.0-beta.6.xcframework.zip",
			checksum: "d6de98951ba1d562675c1270129b672a665b435af93de76aeafebef7308c2d6a"
		)
	]
)