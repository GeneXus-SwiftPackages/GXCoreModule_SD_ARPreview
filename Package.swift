...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.1.0-beta.9.xcframework.zip",
			checksum: "e6ad613fd4c6cab2f190996d84a60a4575b4c0245b3bb5ec3536dac91f5bd318"
		)
	]
)