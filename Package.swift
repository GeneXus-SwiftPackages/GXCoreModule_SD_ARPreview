...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-3.0.1.xcframework.zip",
			checksum: "0f90f30adb7c865381cd585c9785f2644cc58bd41b52d38a3c3ff5fcc2242bb1"
		)
	]
)