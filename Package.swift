...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.1.0-beta.5.xcframework.zip",
			checksum: "acb9dee3964736d1aabfd73ce60d199f0b7f6466c96c0fae7b1a692e047036f6"
		)
	]
)