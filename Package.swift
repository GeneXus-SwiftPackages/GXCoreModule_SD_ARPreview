...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.0.0-beta.30.xcframework.zip",
			checksum: "a043256f0b15de066aaa2483f976e019e48be95f818765809a1f51408b00ff70"
		)
	]
)