...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.2.0-beta.24.xcframework.zip",
			checksum: "555080300e855f3aed31cb7f4ec78b447a84b7f699eb3dcf29a2ad17def56540"
		)
	]
)