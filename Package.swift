...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-1.2.0-rc.29.xcframework.zip",
			checksum: "780531747a632fb54451f3776d6e65a156c4b3f4e7b9e45ef416a4cf3aebc753"
		)
	]
)