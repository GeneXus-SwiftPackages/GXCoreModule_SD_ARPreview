...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-1.2.0-rc.1.xcframework.zip",
			checksum: "94c057e07dc119b62f40e1ac529991c0753173926d01b2c32a5317f3b4616bdc"
		)
	]
)