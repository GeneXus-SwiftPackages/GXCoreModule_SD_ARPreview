...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-1.1.3.xcframework.zip",
			checksum: "aa9518387ace081b1d629f3301ca84ff5deefbd3923ce267e3db70d003078a51"
		)
	]
)