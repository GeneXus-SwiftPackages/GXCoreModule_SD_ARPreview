...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-5.0.0-beta.5.xcframework.zip",
			checksum: "8372f162a6d96272c8347ca344558fd9ad9eb2f378d8a5d78bb8580969f668eb"
		)
	]
)