...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.5.0-beta.3.xcframework.zip",
			checksum: "614286d2eaea9c52c17784bc6d16959aea9d5b7007e13c8295c3916fc23bc479"
		)
	]
)