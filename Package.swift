...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.5.0-beta.4.xcframework.zip",
			checksum: "b599f608c17f73480ed56a784f9fdcf7d597c369a2ba2327d5cc88e7c36bbcaf"
		)
	]
)