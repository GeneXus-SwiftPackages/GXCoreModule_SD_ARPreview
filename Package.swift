...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.2.0-beta.19.xcframework.zip",
			checksum: "f20150d262163ab042c4352232ac32b877a8a62e9027632718d8f35106473662"
		)
	]
)