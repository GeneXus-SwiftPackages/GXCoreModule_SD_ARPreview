...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.2.0-beta.13.xcframework.zip",
			checksum: "cd308e1f61d6f2a6a5b57f9b4400eb9cea02e64a6912065309b0c1d3624ab38b"
		)
	]
)