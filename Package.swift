...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.0.0-beta.5.xcframework.zip",
			checksum: "c0aa1e8ece5fcd82a8249aa093d7d7ed240a2b4e723dc904cb27146c8b5a98eb"
		)
	]
)