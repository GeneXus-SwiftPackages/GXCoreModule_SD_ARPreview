...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-2.0.0-rc.34.xcframework.zip",
			checksum: "0db4ee9b678a502ffd9b187d34a37f4b773ba3b20b1add65ca96b547217dedf9"
		)
	]
)