...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-4.0.0-rc.43.xcframework.zip",
			checksum: "139d5333b91485ad5b1eac65dfbb774db94e179040ae8b23be0adf630e421a13"
		)
	]
)