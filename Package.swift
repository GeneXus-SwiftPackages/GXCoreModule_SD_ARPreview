...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.2.0-beta.21.xcframework.zip",
			checksum: "93b6e0db6cfff4c7f0d1d026d273e66e8d0d6666059690596b28dac50ef85b45"
		)
	]
)