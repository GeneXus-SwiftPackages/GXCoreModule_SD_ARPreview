...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.2.0-beta.24.xcframework.zip",
			checksum: "04c839f12cc72f4099eeb3ccb33e672e85bb3bc5dcd3969509eca757dcf0c16b"
		)
	]
)