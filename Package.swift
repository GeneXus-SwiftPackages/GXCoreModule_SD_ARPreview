...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-3.2.0-rc.11.xcframework.zip",
			checksum: "b19b09722b0fdaa7e997135561f2705fb5e3bd2bb742f0c4f62d04ad9c1ce881"
		)
	]
)