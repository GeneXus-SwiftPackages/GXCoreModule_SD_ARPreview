...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.0.0-beta.48.xcframework.zip",
			checksum: "77c6a3136cf0ac7468874ce78b0bffbf17eeb3035d3b2794c9d26af5351484d4"
		)
	]
)