...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.6.0-beta.1.xcframework.zip",
			checksum: "95408063658fc69e25e5374feb35ff8a8d34b9d0b488f76ee36d84df81464bac"
		)
	]
)