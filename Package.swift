...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.5.0-beta.26.xcframework.zip",
			checksum: "e93e9687fa3a701ae4ffe452d54f84dfabffef5088b9842b0ab4c42c7153797a"
		)
	]
)