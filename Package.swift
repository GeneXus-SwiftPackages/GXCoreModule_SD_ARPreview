...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.2.0-beta.31.xcframework.zip",
			checksum: "d415aff0f64294440c1ec58e52bd39766deba7638927f650da620d6535b02778"
		)
	]
)