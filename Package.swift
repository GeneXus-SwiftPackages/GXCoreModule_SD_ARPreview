...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.2.0-beta.22.xcframework.zip",
			checksum: "94d549bc4bcb4c6ba17a0ab6818131e4354554a47061d01e4fe3d77ea73bee0e"
		)
	]
)