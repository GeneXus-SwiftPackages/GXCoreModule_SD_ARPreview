...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-1.6.0-rc.0.xcframework.zip",
			checksum: "d8944062441b7d1cc8e0dd0c12c378d2fd718fbb99bdcb7a2a701ab29a2f596d"
		)
	]
)