...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.1.0-beta.13.xcframework.zip",
			checksum: "a1c6fad7501a8bb404b57c994e1329e7ca0b72ee2ff5bc7c7ed7f383736149c6"
		)
	]
)