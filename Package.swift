...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.4.0-beta.18.xcframework.zip",
			checksum: "80f68f9d28094a82281c6410b5de8e9b852686eebca2673af2447e81f07f2dfc"
		)
	]
)