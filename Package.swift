...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.5.0-beta.19.xcframework.zip",
			checksum: "ed0b42f2dfd955abe1e84dc73856d6c69dc9460a7b5041d5af3c9daa393eae4a"
		)
	]
)