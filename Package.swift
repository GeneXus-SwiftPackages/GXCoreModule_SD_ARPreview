...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.1.0-beta.12.xcframework.zip",
			checksum: "330a8e0f3b3c61515b1e848ac36f6abf62a6c4f2035898337d39221ecc6284a1"
		)
	]
)