...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.2.0-beta.41.xcframework.zip",
			checksum: "139843929b472b7e9831fd02fc0fed477bd59f8d791be35519549d7f3ff40597"
		)
	]
)