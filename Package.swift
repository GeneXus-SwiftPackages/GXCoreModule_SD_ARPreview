...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.2.0-beta.21.xcframework.zip",
			checksum: "1536d097e1bd12eb3934444fbf8871cffbabdd0771d39a5cd13ea692d7515f32"
		)
	]
)