...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.2.0-beta.14.xcframework.zip",
			checksum: "b8bf71719a247e17bddd43c7a2deda5eab95548b57c17362084eb63572449341"
		)
	]
)