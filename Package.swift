...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.0.0-beta.20230724135409.xcframework.zip",
			checksum: "022fdfdce4f827c54b4ed5fc2ed97e1d705fca50444e6bbf94c64abe9201e7de"
		)
	]
)