...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.2.0-beta.22.xcframework.zip",
			checksum: "334450a582a206de508526a3a56371815a21a6b5aa541ac84aff4c56cba23ab7"
		)
	]
)