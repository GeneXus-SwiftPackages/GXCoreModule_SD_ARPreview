...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.2.0-beta.10.xcframework.zip",
			checksum: "c04992ed2705b00b8d2c6bb1e9b0026dd6f97ad1120e8dc6fb8d3207e2ac0b95"
		)
	]
)