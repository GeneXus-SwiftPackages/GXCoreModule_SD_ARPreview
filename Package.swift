...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-2.2.0-beta.8.xcframework.zip",
			checksum: "a2c595ac91183653d90453f35d474def7694596031860e6248dadca67a9480db"
		)
	]
)