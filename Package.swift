...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-4.0.0.xcframework.zip",
			checksum: "cdc3302c10c8e1f6c242258d7c393f9c673be00f3ed4ec73de7a54b6fc3456e3"
		)
	]
)