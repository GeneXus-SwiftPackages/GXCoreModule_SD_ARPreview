...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-4.0.0-rc.0.xcframework.zip",
			checksum: "7bb0797ab897466517012f7b78b42a245f921b4b7d961605d875f28d860492e6"
		)
	]
)