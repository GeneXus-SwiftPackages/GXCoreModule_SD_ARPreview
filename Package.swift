...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_ARPreview-1.2.0-rc.15.xcframework.zip",
			checksum: "5674b4b0317db5cf774de2eb4a6bc4f2199cc99205c0b506b9e5f4429d994bd4"
		)
	]
)