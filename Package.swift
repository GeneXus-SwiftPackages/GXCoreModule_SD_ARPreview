...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.2.0-beta.12.xcframework.zip",
			checksum: "c33d3b8f63409598cf91779f64055ec171218df4d8e67ca5db42e0cfc98cd6a3"
		)
	]
)