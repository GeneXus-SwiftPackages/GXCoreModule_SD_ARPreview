...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.2.0-beta.29.xcframework.zip",
			checksum: "80f636148b17e2d37302fdfe90d9fa36eb0396189f4d352dd4d36775d14393f5"
		)
	]
)