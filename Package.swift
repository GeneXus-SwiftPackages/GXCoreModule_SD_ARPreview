...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.6.0-beta.0.xcframework.zip",
			checksum: "2c13cda63f61fb8178f8f560d73adc91967f764f6b57c7aac07a335cc1f85c31"
		)
	]
)