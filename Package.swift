...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-4.1.0-beta.18.xcframework.zip",
			checksum: "fe48f2633c8ff4a567c23c2d6351a432665eda320eff717e8064c05dc6062f11"
		)
	]
)