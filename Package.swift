...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.5.0-beta.28.xcframework.zip",
			checksum: "3838620ee069cd5bbe0a94ad1650f63c6fc8aef3ac99b913dd30ad2813af64b4"
		)
	]
)