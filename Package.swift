...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_ARPreview-3.0.3.xcframework.zip",
			checksum: "aabc64c35548b6a22cf6c52d9654e42d1e8f41be42c3a38cf7cca83eb67edd9c"
		)
	]
)