...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-3.1.0-beta.32.xcframework.zip",
			checksum: "b941bc9c101413488f45162045032c612ecc50c9e1352c7cb1f7ad70159e3b15"
		)
	]
)