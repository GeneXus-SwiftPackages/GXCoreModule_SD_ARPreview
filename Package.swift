...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_ARPreview",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_ARPreview-1.5.0-beta.25.xcframework.zip",
			checksum: "f7559ee86e311db91f9d2cef9cbd9fa22caaaffc5d56b600cc60c18d7394fd33"
		)
	]
)